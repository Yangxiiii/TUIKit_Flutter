...
part of 'package:tencent_chat_uikit/src/third_party/extended_text/src/extended/rendering/paragraph.dart';
...
class _SelectableFragment
  ...
  SelectionResult?
    ...
    if (_selectableContainsOriginTextBoundary &&
      ...
      final bool forwardSelection =
          existingSelectionEnd.offset >= existingSelectionStart.offset;
      // zmtzawqlp
      final _RenderParagraph originParagraph = _getOriginParagraph();
      ...
      if (existingSelectionEnd != null) {
        ...
        // zmtzawqlp
        final _RenderParagraph targetParagraph = targetDetails.paragraph;
  ...
  bool _isPlaceholder() {
    ...
    while (current != null) {
      // zmtzawqlp
      if (current is _RenderParagraph) {
        return true;
      }
  ...
  _RenderParagraph _getOriginParagraph() {
    ...
    RenderObject? current = paragraph.parent;
    _RenderParagraph? originParagraph;
    while (current != null) {
      // zmtzawqlp
      if (current is _RenderParagraph) {
  ...
  // zmtzawqlp
  ({_RenderParagraph paragraph, Offset localPosition})?
